# Importar una función en específico desde otro archivo
from tools import limpiar_texto
...
user_name = limpiar_texto(user_name)
user_email = limpiar_texto(user_email)
